...
export const IconRotateCcw = ({ className }) => (
...
export const IconRobot = ({ className }) => (
...
export const IconVolume2 = ({ className }) => (
...
export const IconVolumeX = ({ className }) => (
...
export const IconGamepad = ({ className }) => (
...
export const IconCircle = ({ className }) => (
...
export const IconLightbulb = ({ className = "w-6 h-6", strokeWidth = 2 }) => (
